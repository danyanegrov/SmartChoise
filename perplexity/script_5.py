# Создаем векторный сервис для работы с Milvus

vector_service_content = '''from typing import List, Dict, Any, Optional
import numpy as np
...
recommendation_service_content = '''import asyncio
import json
...
with open("app/services/vector_service.py", "w", encoding="utf-8") as f:
    f.write(vector_service_content)

with open("app/services/recommendation_service.py", "w", encoding="utf-8") as f:
    f.write(recommendation_service_content)

print("✅ Сервисы созданы:")
print("- app/services/vector_service.py")
print("- app/services/recommendation_service.py")